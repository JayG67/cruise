...
export default function RoleBookingList({ roleView, visibleBookings = [], favoriteItineraryActivitiesByBooking = {}, onToggleFavoriteItineraryActivity }) {
  ...
  function toggleFavoriteItineraryActivity(bookingId, activityKey) {
    onToggleFavoriteItineraryActivity?.(bookingId, activityKey)
  }
