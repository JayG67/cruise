...
describe('React route preview accessibility contracts', () => {
  ...
  it('keeps React person selector on searchable cards instead of a giant dropdown', () => {
    ...
    expect(selector).toContain('Turnaround people are shown inside one cruise-line assignment at a time')
  ...
  it('keeps turnaround person selector assignment-integrity review guardrailed', () => {
    ...
    expect(roleSelector).toContain('function getOperationalAssignmentAudit')
    expect(roleSelector).toContain('function getOperationalAssignmentRoster')
    expect(roleSelector).toContain('function getOperationalDeploymentMatrix')
    expect(roleSelector).toContain('data-testid="react-operational-assignment-audit-panel"')
    expect(roleSelector).toContain('data-testid="react-operational-assignment-audit-guardrail"')
    expect(roleSelector).toContain('cross-line cards visible')
    expect(roleSelector).toContain('Panel shows {operationalAssignmentAudit.visibleCardCount} people at once')
    expect(roleSelector).toContain('data-testid="react-operational-assignment-roster-panel"')
    expect(roleSelector).toContain('data-testid="react-operational-assignment-roster-ship-row"')
    expect(roleSelector).toContain('data-testid="react-operational-assignment-roster-role-row"')
    expect(roleSelector).toContain('data-testid="react-operational-deployment-matrix-panel"')
    expect(roleSelector).toContain('data-testid="react-operational-deployment-matrix-row"')
    expect(roleSelector).toContain('role coverage')
    expect(selectors).toContain("operationalAssignmentAuditPanel: 'react-operational-assignment-audit-panel'")
    expect(selectors).toContain("operationalAssignmentAuditGuardrail: 'react-operational-assignment-audit-guardrail'")
    expect(selectors).toContain("operationalAssignmentRosterPanel: 'react-operational-assignment-roster-panel'")
    expect(selectors).toContain("operationalAssignmentRosterShipRow: 'react-operational-assignment-roster-ship-row'")
    expect(selectors).toContain("operationalDeploymentMatrixPanel: 'react-operational-deployment-matrix-panel'")
    expect(selectors).toContain("operationalDeploymentMatrixRow: 'react-operational-deployment-matrix-row'")
    expect(cypressSpec).toContain("cy.getByTestId(rs.operationalAssignmentAuditGuardrail).should('contain.text', '0 cross-line cards visible')")
    expect(cypressSpec).toContain("cy.getByTestId(rs.operationalAssignmentRosterShipRow).should('have.length', 2)")
    expect(cypressSpec).toContain("cy.getByTestId(rs.operationalAssignmentAuditCounts).should('contain.text', '20 matching people')")
    expect(cypressSpec).toContain("cy.getByTestId(rs.operationalDeploymentMatrixSummary).should('contain.text', 'ships fully covered')")
    expect(cypressSpec).toContain("cy.getByTestId(rs.operationalDeploymentMatrixRow).should('have.length', 1)")
  })
