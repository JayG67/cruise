...
assert(statusSource.includes("{ phase: 2, name: 'Turnaround briefing', status: 'IN_PROGRESS' }"), 'Program status must keep Phase 2 not started.')
...
console.log('Phase 2: IN_PROGRESS')
