...
assert(statusSource.includes("{ phase: 3, name: 'Evaluation harness', status: 'IN_PROGRESS' }"), 'Phase 3 must be allowed to progress while Phase 1 remains complete.')
assert(statusSource.includes("currentPhase: 3"), 'Phase 3 must be the current phase.')
