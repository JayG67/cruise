...
if (readiness.status !== 'IN_PROGRESS' || readiness.percentComplete !== 75) throw new Error('Phase 6 readiness is not synchronized at 50%.')
if (status.currentPhase !== 6 || status.completedPhases !== 5 || status.currentPhasePercentComplete !== 75) throw new Error('AI program status is not synchronized with Phase 6 CI integration.')
