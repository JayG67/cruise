...
assertIncludes(expressApp, "app.use(express.static(reactBuildDir, { redirect: false", 'Express React static asset route')
...
assertExcludes(expressApp, "app.use('/retired'", 'Express app')
assertIncludes(app, 'react-production-shell', 'React app shell')
assertIncludes(app, 'ReactQueryStatusPanel', 'React app shell')

console.log('React readiness audit passed.')

assertExcludes(expressApp, "app.use('/retired-route-placeholder'", 'Express app')
