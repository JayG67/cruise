...
assertContains(bookingWorkflow, 'async function saveBookingDraftFor', 'React booking draft workflow hook')
assertContains(bookingWorkflow, 'Booking draft saved through the React mutation boundary.', 'React booking draft workflow hook')
